...
namespace SistemaRRHH
{
    public partial class FormGestionEmpleados : Form
    {
        ...
        public FormGestionEmpleados()
        {
            ...
            // Apartado de mostrar cargos en el ComboBox al iniciar el formulario
            try
            {
        ...
        {
            // 1. Rompemos los enlaces de los ComboBoxes de Empleados
